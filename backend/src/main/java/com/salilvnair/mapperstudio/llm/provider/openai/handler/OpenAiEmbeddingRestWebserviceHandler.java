...
import com.salilvnair.mapperstudio.llm.provider.openai.context.OpenAiEmbeddingApiContext;
import com.salilvnair.mapperstudio.llm.provider.openai.delegate.OpenAiEmbeddingRestWebserviceDelegate;
import com.salilvnair.mapperstudio.llm.provider.openai.model.OpenAiEmbeddingRequest;
import com.salilvnair.mapperstudio.llm.provider.openai.model.OpenAiEmbeddingResponse;
...
public class OpenAiEmbeddingRestWebserviceHandler implements RestWebServiceHandler {

    private final OpenAiEmbeddingRestWebserviceDelegate delegate;
