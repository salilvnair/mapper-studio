...
('MAPPING_STUDIO', 'ANY', 'REGEX', '(?i)^(publish|confirm|approve|yes|generate excel|download excel|export excel|generate xlsx|download xlsx|export xlsx)$', 'SET_TASK', 'mappingStudioTask:publishMappingArtifact', 500, 1, 'Publish artifacts', 'PIPELINE_RULES'),
